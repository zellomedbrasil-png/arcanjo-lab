...
function Toast({ toast }: { toast: ToastItem }) {
  ...
  return (
    <div
      className={`flex items-start gap-3 bg-white rounded-xl shadow-lg border border-gray-100 border-l-4 ${borders[toast.type]} px-4 py-3 min-w-64 max-w-sm animate-in slide-in-from-right-4 fade-in duration-200`}
    >
      {icons[toast.type]}
