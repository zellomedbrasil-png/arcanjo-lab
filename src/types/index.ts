...
export type TipoGuia =
  ...
  // Ultrassonografia
  | 'US_ABD_TOTAL' | 'US_ABD_TOTAL_DOPPLER' | 'US_ABD_SUPERIOR'
  | 'US_PELVICO' | 'US_TRANSVAGINAL' | 'US_TRANSVAGINAL_DOPPLER' | 'US_PROSTATA'
  | 'US_TIREOIDE' | 'US_TIREOIDE_DOPPLER' | 'US_BOLSA_ESCROTAL' | 'US_BOLSA_ESCROTAL_DOPPLER'
  | 'US_CERVICAL' | 'US_CERVICAL_DOPPLER' | 'US_AXILAS' | 'US_PAREDE_ABD'
  | 'US_VIAS_BILIARES' | 'US_MAMA_BILATERAL' | 'US_PARTES_MOLES' | 'US_RENAL'
  | 'US_VIAS_URINARIAS_FEM' | 'US_VIAS_URINARIAS_MASC'
  | 'US_DOPPLER_CAROTIDAS' | 'US_DOPPLER_RENAIS' | 'US_DOPPLER_COLORIDO_ESTRUT'
  | 'DOPPLER_MMI_ARTE' | 'DOPPLER_MMI_VENO'
  | 'DOPPLER_MMS_DIR' | 'DOPPLER_MMS_ESQ' | 'DOPPLER_MMI_INF_DIR' | 'DOPPLER_MMI_INF_ESQ'
  // Articulações
  | 'ARTICULACAO_GERAL' | 'ARTICULACAO_DOPPLER' | 'ARTICULACAO_JOELHO' | 'ARTICULACAO_QUADRIL'
  | 'ARTICULACAO_ESTERNOCLAVICULA' | 'ARTICULACAO_COTOVELO' | 'ARTICULACAO_MAO'
  | 'ARTICULACAO_OMBRO' | 'ARTICULACAO_PE' | 'ARTICULACAO_PUNHO' | 'ARTICULACAO_SACROILIACA' | 'ARTICULACAO_TORNOZELO'
  // Endoscopia
