      ...
      <div className="max-w-4xl mx-auto px-4 py-4 pb-24 space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className="hidden sm:flex items-center gap-1 text-xs text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-lg border border-emerald-100">
              <Sparkles size={11} />
          ...
          <div className="flex min-w-0 flex-1 items-center gap-2 text-sm overflow-hidden">
            ...
            {hasProcedimentos && (
              <>
                ...
                <span className="flex items-center gap-1 text-emerald-600 font-semibold text-xs shrink-0">
                  <FileText size={12} />
