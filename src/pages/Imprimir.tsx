...
export default function Imprimir() {
  ...
  return (
    <div className="min-h-screen bg-gray-200 print:bg-white p-4 print:p-0">
      ...
      <div className={
        isSADT
          ? 'max-w-[29.7cm] mx-auto bg-white min-h-[21cm] shadow-xl print:shadow-none print:w-[29.7cm] print:h-[21cm] print:m-0 overflow-hidden relative font-sans text-black'
        ...
        {({
          IPM:        <GuiaIPM />,
          ISSEC:      <GuiaISSEC />,
          PARTICULAR: <GuiaParticular />,
          SADT:       <GuiaSADTPadrao operadora={sadtOperadora} registroAns={sadtRegistroAns} />,
        } as Record<Convenio, React.ReactElement>)[convenio]}
      </div>
    </div>
  );
}
